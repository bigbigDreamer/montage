import require$$1, { useState, useCallback, forwardRef, useRef, useEffect, useImperativeHandle } from 'react';
...
function useForceUpdate() {
  const [, dispatch] = useState(Object.create(null)); // Turn dispatch(required_parameter) into dispatch().
...
const ReactWalineClient = /*#__PURE__*/forwardRef((props, ref) => {
