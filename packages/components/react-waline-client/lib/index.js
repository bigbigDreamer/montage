...
var client = require('@waline/client');
...
function requireReactJsxRuntime_production_min() {
    ...
    requireObjectAssign();
    var f = require$$1__default["default"], g = 60103;
...
function useForceUpdate() {
  const [, dispatch] = require$$1.useState(Object.create(null)); // Turn dispatch(required_parameter) into dispatch().

  return require$$1.useCallback(() => {
...
const ReactWalineClient = /*#__PURE__*/require$$1.forwardRef((props, ref) => {
  ...
  require$$1.useImperativeHandle(ref, () => {
    return {
      update: props => {
        var ref;
        return ((ref = walineInstanceRef.current) == null ? void 0 : ref.update == null ? void 0 : ref.update(_extends({}, props))) && forceUpdate();
      }
    };
  });
  return /*#__PURE__*/jsxRuntime.exports.jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxRuntime.exports.jsx("div", {
      ...
      children: ["当前页共有", /*#__PURE__*/jsxRuntime.exports.jsx("span", {
...
module.exports = ReactWalineClient;
