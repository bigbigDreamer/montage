...
const ReactWalineClient = /*#__PURE__*/react.forwardRef((_param, ref) => {
  var {
    className,
    style
  } = _param,
  ...
  const walineInstanceRef = react.useRef({});
  const containerRef = react.useRef(null);
  const containerCls = classes__default["default"]('montage-react-waline-client_container');
  react.useEffect(() => {
